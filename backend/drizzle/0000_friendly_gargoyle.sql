...
CREATE TABLE "quotes" (
	...
	"risk_buffer" numeric(10, 2) DEFAULT '0'
);
--> statement-breakpoint
...
ALTER TABLE "blog_files" ADD CONSTRAINT "blog_files_post_id_blog_posts_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."blog_posts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "cart_items" ADD CONSTRAINT "cart_items_campaign_id_group_buying_campaigns_id_fk" FOREIGN KEY ("campaign_id") REFERENCES "public"."group_buying_campaigns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "component_applications" ADD CONSTRAINT "component_applications_subcategory_id_component_subcategories_i" FOREIGN KEY ("subcategory_id") REFERENCES "public"."component_subcategories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "group_buying_participants" ADD CONSTRAINT "group_buying_participants_campaign_id_group_buying_campaigns_id" FOREIGN KEY ("campaign_id") REFERENCES "public"."group_buying_campaigns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
